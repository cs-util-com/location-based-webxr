...
- Circle smoothing is snap-then-damp with a fixed per-frame lerp factor 0.15 (prototype parity; deliberately frame-rate dependent — dt-normalization via `lerp-utils` is a candidate follow-up).
