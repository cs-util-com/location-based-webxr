...
Last recorded 2026-09-10T10:51:12.422Z · machine `f936c64e (11th Gen Intel(R) Core(TM) i7-1185G7 @ 3.00GHz, 8 threads)` · branch `r680` @ `5d9e8ae4`
...
| --- | ---: | ---: | ---: | --- | ---: | --- |
| `format` | 1.3 s | ≈ | 1.0 s | – | – | |
| `lint` | 6.0 s | +2.1 s (+55 %) | 3.9 s | – | – | 🔺 slower |
...
- `format`: 1.3, 0.9, 0.9, 0.9, 1.0, 0.9, 0.9, 1.0, 1.2, 1.4
- `lint`: 6.0, 3.9, 4.3, 4.4, 4.0, 3.4, 3.4, 3.8, 5.7, 3.7
- `lint:css`: 1.4, 1.1, 1.1, 1.1, 1.0, 0.9, 0.9, 1.0, 1.5, 1.0
- `check:dup`: 1.0, 0.7, 0.7, 0.7, 0.8, 0.7, 0.7, 0.8, 1.0, 0.7
- `check:cycles`: 1.2, 0.9, 1.0, 0.9, 1.0, 0.9, 0.9, 1.0, 1.3, 0.9
- `check:boundaries`: 1.4, 1.1, 1.1, 1.2, 1.0, 0.9, 0.9, 1.0, 1.5, 1.1
- `typecheck`: 2.1, 1.2, 1.2, 1.4, 1.2, 1.3, 1.3, 1.2, 2.0, 1.3
- `typecheck:tests`: 2.1, 1.3, 1.3, 1.6, 1.3, 1.3, 1.3, 1.3, 1.9, 1.5
- `test:unit`: 2.0, 1.6, 1.7, 1.8, 2.2, 2.0, 2.0, 2.1, 3.0, 2.1
...
{
  "version": 1,
  "meta": {"project":"GpsPlusSlamJs_AnchorStarter","lastWrite":{"ts":"2026-09-10T10:51:12.422Z","machine":"f936c64e|11th-Gen-Intel-R-Core-TM-i7-1185G7-3-00G|8","machineLabel":"f936c64e (11th Gen Intel(R) Core(TM) i7-1185G7 @ 3.00GHz, 8 threads)","git":"5d9e8ae4","branch":"r680"}},
  "stages": {
    "format": { "history": [
