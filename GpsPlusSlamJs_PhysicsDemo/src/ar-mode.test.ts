 ...
 * visibly slower than the RecorderApp (32×32 @ 2 Hz) — 8× fewer depth points
 * per second (2026-07-16-1547 user feedback). This pins that the demo starts
 * depth capture at the shared framework reconstruction cadence.
 */
