...
export async function startArMode(deps: ArModeDeps): Promise<() => void> {
  ...
  // at the framework RECONSTRUCTION cadence (recorder parity, 32×32 @ 2 Hz) —
  // the bare-fallback 16×16 @ 1 Hz fed 8× fewer points/s and built the mesh
  // visibly slower (2026-07-16-1547 field feedback).
  startDepthCapture({
