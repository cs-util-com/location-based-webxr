...
| `compass-vote-weight`              | range    | Steady-state compass vote weight 0–1 step 0.05 (default **0.1** — census optimum, 2026-07-20; applies while experiment/rotation prior active)                                                                            |
