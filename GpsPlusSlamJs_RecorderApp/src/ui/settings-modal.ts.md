...
| `compass-rotation-prior`           | checkbox | Compass Stage C — trust-gated rotation prior (default **off**)                                                                                                                                                           |
| `compass-webxr-consistency`        | checkbox | Compass↔WebXR consistency trust gate (default **off**)                                                                                                                                                                   |
| `compass-experiment`               | checkbox | 2026-07-19 field-test combo: trust vote (15° tol) + C′ pair selection (default **off**)                                                                                                                                  |
| `compass-robust-solver-comparison` | checkbox | Alternative robust-solver comparison arm — not a compass mechanism (default **off**)                                                                                                                                     |
| `compass-vote-weight`              | range    | Steady-state compass vote weight 0–1 step 0.05 (default **0.3**; census optimum 0.1; applies while experiment/rotation prior active)                                                                                     |
| `compass-vote-weight-value`        | span     | Display: "0.30"                                                                                                                                                                                                          |
