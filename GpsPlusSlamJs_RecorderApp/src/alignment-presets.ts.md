...
- `ALIGNMENT_PRESETS` — seven entries, in dropdown order:
  ...
  - The MEMORY LADDER (2026-09-12): `w45`, `w90`, `w180`, `w300`, `wall`. One variable — how far back the solver may look — and nothing else. Offline, reference-free, scored from observation 160 over 159 recordings: `w45` is worse than shipped on 156, `w90` on 91, `w180` on 28, `w300` on 11, `wall` on 5 (and better on 154). `w45` is present DESPITE being the worst, because a ladder with no bad rung cannot calibrate the eye against the numbers.
