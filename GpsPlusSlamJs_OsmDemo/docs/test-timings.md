...
Last recorded 2026-09-12T05:51:42.680Z · machine `f936c64e (11th Gen Intel(R) Core(TM) i7-1185G7 @ 3.00GHz, 8 threads)` · branch `r694` @ `879f935c`
...
| `check:dup` | 3.5 s | ≈ | 3.9 s | – | – | |
| `check:cycles` | 2.0 s | ≈ | 2.1 s | – | – | |
| `check:boundaries` | 3.9 s | ≈ | 3.6 s | – | – | |
| `typecheck` | 2.3 s | ≈ | 2.0 s | – | – | |
| `typecheck:tests` | 3.2 s | ≈ | 2.2 s | – | – | |
| `test:unit` | 30.8 s | ≈ | 29.0 s | 1602 passed, 1 skipped | 0 | |
| `test:e2e` | 1128.9 s | ≈ | 1170.3 s | 80 passed | 0 | |
| `check:deadcode` | 3.8 s | ≈ | 3.7 s | – | – | |
| **total** | 1199.9 s | ≈ | 1210.7 s | 1682 passed, 1 skipped | 0 | |

## History (last 10 recordings per stage, newest first, seconds)

- `build:osm`: 0.2, 0.1, 0.1, 0.1, 0.2, 0.2, 0.1, 0.1, 0.2, 0.1
- `build:framework`: 0.2, 0.1, 0.1, 0.1, 0.2, 0.3, 0.1, 0.2, 0.3, 0.1
- `format`: 9.4, 9.1, 7.0, 8.8, 15.0, 20.4, 7.6, 10.0, 12.6, 7.1
- `lint`: 13.4, 16.5, 11.8, 15.1, 27.6, 37.1, 14.2, 16.0, 21.1, 11.9
- `lint:css`: 1.5, 1.5, 1.1, 1.3, 2.1, 2.6, 1.3, 1.5, 2.5, 1.1
- `check:dup`: 3.5, 4.0, 3.0, 3.6, 5.8, 7.2, 4.4, 3.8, 6.4, 3.1
- `check:cycles`: 2.0, 2.2, 1.6, 1.9, 3.1, 4.2, 2.0, 2.4, 3.1, 1.6
- `check:boundaries`: 3.9, 3.4, 2.6, 3.2, 5.4, 7.0, 2.9, 3.9, 4.9, 2.6
- `typecheck`: 2.3, 1.8, 1.3, 1.5, 3.1, 4.0, 1.8, 2.1, 3.6, 1.4
- `typecheck:tests`: 3.2, 2.1, 1.6, 1.7, 4.0, 4.6, 2.0, 2.4, 3.5, 1.6
- `test:unit`: 30.8, 29.8, 21.0, 26.0, 47.2, 29.8, 28.3, 36.2, 21.6, 20.8
- `test:e2e`: 1128.9, 971.1, 1285.6, 1172.0, 1175.2, 1304.4, 1168.7, 1005.2, 1014.7, 1271.5
- `check:deadcode`: 3.8, 3.6, 3.9, 4.0, 3.9, 3.5, 3.6, 3.6, 3.6, 4.1
- `total`: 1199.9, 1023.0, 1349.8, 1238.9, 1247.0, 1221.4, 1055.3, 1069.5, 1371.6, 1133.9

```json
{
  "version": 1,
  "meta": {"project":"GpsPlusSlamJs_OsmDemo","lastWrite":{"ts":"2026-09-12T05:51:42.680Z","machine":"f936c64e|11th-Gen-Intel-R-Core-TM-i7-1185G7-3-00G|8","machineLabel":"f936c64e (11th Gen Intel(R) Core(TM) i7-1185G7 @ 3.00GHz, 8 threads)","git":"879f935c","branch":"r694"}},
  "stages": {
    "typecheck": { "history": [
