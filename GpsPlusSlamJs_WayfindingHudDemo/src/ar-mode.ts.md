...
- **Entrance readout ([HUD diamond entrance plan](../../../gps-plus-slam/GpsPlusSlamJs_Docs/docs/2026-09-05-2138-hud-diamond-entrance-animation-plan.md), M4):** the per-frame status line passes `hud.entranceStats()` into `summarizeHudScene`, so the headset shows the entrance's redraw cost while it animates.
