...
Both modes share a live control panel (deadband distances + indicator scale) that re-creates the HUD on change, plus a status line derived from the HUD's actual scene output.
